...
<form action="admin?action=updateproduct" method="post">
	<div>
		...
		<br/>
		<div><label>Enter Description : </label> <input style="color:lightgrey;" type="text" name="pdesc" value="<%=product.getProductDescription()%>"></div>
		<br/>
		<div><label>Enter Price : </label> <input style="color:lightgrey;" type="text" name="pcost" value="<%=product.getCost()%>"></div>
		<br/>
